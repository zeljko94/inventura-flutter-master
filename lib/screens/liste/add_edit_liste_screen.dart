...
class _AddEditListaScreenState extends State<AddEditListaScreen> {
  ...
  Future<List<Artikl>> _fetchAritkliSuggestions(String textFieldValue) {
    return Future.delayed(Duration.zero, () async {
      ...
      return artikli.where((x) => x.naziv!.toLowerCase().contains(textFieldValue.toLowerCase())).toList();
    });
  }
  ...
  _resetControllers() {
    ...
    var listItem = ListItem(
      artikl: odabraniArtikl, artiklId: odabraniArtikl!.id, listId: widget.lista != null ? widget.lista!.id : 0, kolicina: 1, 
  ...
  void _updateDodaniArtikl(ListItem dodaniArt) {
    ...
    if(existing != null) {
      ...
      existing.listId = dodaniArt.listId;
